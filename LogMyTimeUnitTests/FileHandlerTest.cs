...
namespace LogMyTimeUnitTests
{
    ...
    public class FileHandlerTest
    {
        ...
        public void ShouldReadFromFile()
        {
            FileHandler io = new FileHandler();
            io.InjectPath(Directory.GetCurrentDirectory());
            Assert.AreEqual<string>("20001201;20001201080000;20001201180100", io.ReadFromFile("2000\\12\\", "20001201.csv"));
        }
        ...
        public void ShouldWriteFile()
        {
            ...
            io.WriteToFile("2000\\12\\", "20001210.csv", "20001210;20001210060000;20001210040000");
            Assert.AreEqual<string>("20001210;20001210060000;20001210040000", io.ReadFromFile("2000\\12\\", "20001210.csv"));
            List<String> files = io.ListAllFiles("2000\\12\\");
            Assert.IsTrue(files.Count != 0);
            Assert.AreEqual<string>("20001201.csv", files[0]);
